...
import { getClientSummaries, getAllResponsaveis, getAllStatuses } from "@/data/clients";
              ...
              <tbody className="divide-y divide-border">
                {filtered.map(c => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <span className="font-semibold text-card-foreground">{c.totalEntregues}</span>
                    ...
                    <td className="px-5 py-4 text-muted-foreground text-xs">
                      {c.vencimentoContrato ? new Date(c.vencimentoContrato + "T00:00:00").toLocaleDateString("pt-BR") : "—"}
                    </td>
                    <td className="px-5 py-4">
